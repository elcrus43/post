...
# VK OAuth (из vk.com/apps)
VK_CLIENT_ID=51xxxxxx
VK_CLIENT_SECRET=xxxxxxxxxxxxxxxxxxxx
VK_REDIRECT_URI=https://your-app.railway.app/api/auth/vk/callback

# OK OAuth (из apiok.ru)
OK_APP_ID=51xxxxxx
OK_SECRET_KEY=xxxxxxxxxxxxxxxxxxxx
OK_PUBLIC_KEY=xxxxxxxxxxxxxxxxxxxx
OK_REDIRECT_URI=https://your-app.railway.app/api/auth/ok/callback

# TenChat OAuth (из TenChat API)
TENCHAT_CLIENT_ID=smm-planner
TENCHAT_CLIENT_SECRET=xxxxxxxxxxxxxxxxxxxx
TENCHAT_REDIRECT_URI=https://your-app.railway.app/api/auth/tenchat/callback

# Twitter (X) OAuth 2.0 (из developer.x.com)
TWITTER_CLIENT_ID=xxxxxxxxxxxxxxxxxxxx
TWITTER_CLIENT_SECRET=xxxxxxxxxxxxxxxxxxxx
TWITTER_REDIRECT_URI=https://your-app.railway.app/api/auth/twitter/callback`;
...
4. Сохранить preset name`} />
            ...
            <Step number={5} title="OAuth — настроить авторизацию (VK и OK)">
              <div className="space-y-3">
                ...
                <Alert type="warning">
                  Не забудьте добавить все эти ключи в Railway Dashboard → Variables!
                </Alert>
              </div>
            </Step>

            <Step number={6} title="Vercel — деплой React фронтенда">
              <div className="space-y-3">
            ...
            <Step number={7} title="Проверка — всё работает?">
              <div className="space-y-3">
